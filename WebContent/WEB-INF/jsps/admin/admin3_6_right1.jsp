...
<div id="right1">
		<div class="main">
			<div class="tit">当前位置》留言管理》添加留言</div>
			<div class="box2">
			  <div class="tit1">添加留言：</div>
		 <%
...
<%}%>	   				   
	...
	<form  action="${pageContext.request.contextPath}/admin/toadmin3_6_rightadd.do" method="post">
	<table width="675" border="1" align="center" >				 
				  <tr>	  
				    <td height="36">留言标题 ：</td>
				    <td>
				    <input type="text" name="mesTitle" value="" maxlength="10" onchange="if( this.value ==''){alert('留言标题为空');}"/>
				    </td>
				  </tr>
				  ...
				  <tr>
				    <td >留言内容 ：</td>
				    <td >
				    <textarea  name="mesContent" rows="10" cols="50" onchange="if( this.value ==''){alert('留言内容为空');}"></textarea>
				    </td>
				  </tr>
			 <tr>	  
				    <td height="36">留言人 ：</td>
				    <td>
				    <input type="text" name="userName" value="" maxlength="10" onchange="if( this.value ==''){alert('留言人不能为空');}"/>
				    </td>
				  </tr>
                  </table>
