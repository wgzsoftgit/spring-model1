...
<div class="container"> 		
		...
		<div class="banner_erji">
        	...
        	<img src="../static/img/index/pic_1.jpg" width="1000" height="187" alt="" title=""/>        </div>
        ...
        <li><h3><a href="${pageContext.request.contextPath }/index/toactivity.do">景点活动</a></h3></li>
        <li><h3><a href="${pageContext.request.contextPath }/index/toways.do">智能路线</a></h3></li>
        <li><h3><a href="${pageContext.request.contextPath }/index/tovideo.do">直播平台</a></h3></li>
        <li><h3><a href="${pageContext.request.contextPath }/admin/tomessage.do">在线留言</a></h3></li>
        <li><h3><a href="${pageContext.request.contextPath }/index/toconnection.do">联系我们</a></h3></li>
...
<li >
   <h3><a href="${pageContext.request.contextPath}/index/torevise.do">修改个人信息</a></h3>
        	...
        	<div class="rightbar">
            	...
            	<div class="bread"><a href="${pageContext.request.contextPath }/index/toindex_index.do">首页</a> > 旅游风景</div>
 ...
 <c:if test="${scenic.sceIspush >0}">
         <li>
             ...
             <a href="${pageContext.request.contextPath }/index/tointroduce.do?sceId=${scenic.sceId}">       <img src="${scenic.scePicture}" width="220" height="140"/><span>${scenic.sceName}</span>
            </a>
                  </li>
...
<!--分页 -->
    ...
    <c:if test="${pageBean.currentPage>1 }">
        <a href="${pageContext.request.contextPath }/index/toscenic.do?page=${pageBean.currentPage-1}">上一页</a>
    </c:if>
        <a href="${pageContext.request.contextPath }/index/toscenic.do?page=${1}">首页</a>
            <c:forEach begin="1" end="${pageBean.totalPage }" step="1" var="i">
                <c:if test="${pageBean.currentPage==i }">
                    <a href="${pageContext.request.contextPath }/index/toscenic.do?page=${i}"><font color="#ff0000">${i}</font></a>
                </c:if>
                <c:if test="${pageBean.currentPage!=i }">
                    <a href="${pageContext.request.contextPath }/index/toscenic.do?page=${i}">${i}</a>
                </c:if>
            </c:forEach>
  <c:if test="${pageBean.currentPage>1 }">
        <a href="${pageContext.request.contextPath }/index/toscenic.do?page=${pageBean.totalPage}">末页</a>
  </c:if>
    <c:if test="${pageBean.currentPage< pageBean.totalPage }">
        <a href="${pageContext.request.contextPath }/index/toscenic.do?page=${pageBean.currentPage+1}">下一页</a>
    </c:if>
    </div>
