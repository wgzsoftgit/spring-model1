...
<div class="header"> 
	...
	<div class="w1000">
       	...
       	<p>你好，欢迎&nbsp;&nbsp;<font style="color=red" >${userName }</font> &nbsp;&nbsp;光临河南省旅游景点互动平台！</p>
...
<div class="container"> 		
		...
		<div class="banner_erji">
        	...
        	<img src="../static/img/index/way.jpg" width="1000" height="187" alt="" title=""/>        </div>
...
<li >
   <h3><a href="${pageContext.request.contextPath}/index/torevise.do">修改个人信息</a></h3>
        	...
        	<div class="rightbar">
            	...
            	<div class="bread"><a href="${pageContext.request.contextPath}/index/toindex_login.do">首页</a> >最新路线</div>

			<ul class="ul_news">
                	    
  <c:forEach items="${pageBean.products}" var="Ways"> 
     ...
     <a href="${pageContext.request.contextPath }/index/towaysshow.do?wayId=${Ways.wayId}" style="max-width: 500px;
    overflow: hidden;
    white-space: nowrap;
    text-overflow: ellipsis;
    display:block;
    float:left;" >${Ways.wayContent }</a><br />
...
<!--分页 -->
    ...
    <c:if test="${pageBean.currentPage>1 }">
        <a href="${pageContext.request.contextPath }/index/toways.do?page=${pageBean.currentPage-1}">上一页</a>
    </c:if>
        <a href="${pageContext.request.contextPath }/index/toways.do?page=${1}">首页</a>
            <c:forEach begin="1" end="${pageBean.totalPage }" step="1" var="i">
                <c:if test="${pageBean.currentPage==i }">
                    <a href="${pageContext.request.contextPath }/index/toways.do?page=${i}"><font color="#ff0000">${i}</font></a>
                </c:if>
                <c:if test="${pageBean.currentPage!=i }">
                    <a href="${pageContext.request.contextPath }/index/toways.do?page=${i}">${i}</a>
                </c:if>
            </c:forEach>
  <c:if test="${pageBean.currentPage>1 }">
        <a href="${pageContext.request.contextPath }/index/toways.do?page=${pageBean.totalPage}">末页</a>
  </c:if>
    <c:if test="${pageBean.currentPage< pageBean.totalPage }">
        <a href="${pageContext.request.contextPath }/index/toways.do?page=${pageBean.currentPage+1}">下一页</a>
    </c:if>
    </div>
