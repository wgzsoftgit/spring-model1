...
<div class="container"> 		
		...
		<div class="banner_erji">
        	...
        	<img src="../static/img/index/banner_erji6.jpg" width="1000" height="187" alt="" title=""/>        </div>
...
<li >
   <h3><a href="${pageContext.request.contextPath}/index/torevise.do">修改个人信息</a></h3>
        	...
        	<div class="rightbar">
            	...
            	<div class="bread"><a href="${pageContext.request.contextPath}/index/toindex_login.do">首页</a> >给我留言</div>
...
<%}%>
               <form  action="${pageContext.request.contextPath}/admin/todeal_message.do" method="post">
	<ul>
		<li>
			<label>您的称呼：</label><input id="userName" name="userName" type="text" class="yuyue_in"  maxlength="8"/> 
		</li>
		<li>
			<label>留言标题：</label><input id="mesTitle" name="mesTitle" type="text" class="yuyue_in" maxlength="10"/> 
		</li>
		<li>	
			<label>你的留言：</label><textarea id="mesContent" name="mesContent" cols="" rows="" class="yuyue_te"></textarea> 
		</li>
		<li>
